...
const RegisterPage32 = () => {
  const navigation = useNavigation();

  return (
    <ScrollView
      style={styles.registerPage32}
      showsHorizontalScrollIndicator={false}
      showsVerticalScrollIndicator={false}
      contentContainerStyle={styles.registerPage32Content}
    >
      <View style={styles.frameParent}>
        <View style={styles.frameParent}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/cardgoals21.png")}
          />
        </View>
        <LinearGradient
        ...
        >
          <TouchableOpacity
            ...
            activeOpacity={0.2}
            onPress={() => navigation.navigate("RegisterPage33")}
          >
